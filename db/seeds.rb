...
b11exp = Type.create!( code: "b11", flow: "exp", label: "cntr vide 20ft (nb)", unit: "tonnes" )
b11imp = Type.create!( code: "b11", flow: "imp", label: "cntr vide 20ft (nb)", unit: "tonnes" )
b12exp = Type.create!( code: "b12", flow: "exp", label: "cntr vide 40ft (nb)", unit: "tonnes" )
b12imp = Type.create!( code: "b12", flow: "imp", label: "cntr vide 40ft (nb)", unit: "tonnes" )
b13exp = Type.create!( code: "b13", flow: "exp", label: "cntr vide entre 20ft et 40ft (nb)", unit: "tonnes" )
b13imp = Type.create!( code: "b13", flow: "imp", label: "cntr vide entre 20ft et 40ft (nb)", unit: "tonnes" )
b14exp = Type.create!( code: "b14", flow: "exp", label: "cntr vide > 40ft (nb)", unit: "tonnes" )
b14imp = Type.create!( code: "b14", flow: "imp", label: "cntr vide > 40ft (nb)", unit: "tonnes" )
b1exp = Type.create!( code: "b1", flow: "exp", label: "cntr vide (nb)", unit: "tonnes" )
b1imp = Type.create!( code: "b1", flow: "imp", label: "cntr vide (nb)", unit: "tonnes" )
b21exp = Type.create!( code: "b21", flow: "exp", label: "cntr plein 20ft (nb)", unit: "tonnes" )
b21imp = Type.create!( code: "b21", flow: "imp", label: "cntr plein 20ft (nb)", unit: "tonnes" )
b22exp = Type.create!( code: "b22", flow: "exp", label: "cntr plein 40ft (nb)", unit: "tonnes" )
b22imp = Type.create!( code: "b22", flow: "imp", label: "cntr plein 40ft (nb)", unit: "tonnes" )
b23exp = Type.create!( code: "b23", flow: "exp", label: "cntr plein entre 20ft et 40ft (nb)", unit: "tonnes" )
b23imp = Type.create!( code: "b23", flow: "imp", label: "cntr plein entre 20ft et 40ft (nb)", unit: "tonnes" )
b24exp = Type.create!( code: "b24", flow: "exp", label: "cntr plein > 40ft (nb)", unit: "tonnes" )
b24imp = Type.create!( code: "b24", flow: "imp", label: "cntr plein > 40ft (nb)", unit: "tonnes" )
b2exp = Type.create!( code: "b2", flow: "exp", label: "cntr plein (nb)", unit: "tonnes" )
b2imp = Type.create!( code: "b2", flow: "imp", label: "cntr plein (nb)", unit: "tonnes" )
bexp = Type.create!( code: "b", flow: "exp", label: "conteneur (nb)", unit: "tonnes" )
bimp = Type.create!( code: "b", flow: "imp", label: "conteneur (nb)", unit: "tonnes" )
c1exp = Type.create!( code: "c1", flow: "exp", label: "vide (EVP)", unit: "tonnes" )
c1imp = Type.create!( code: "c1", flow: "imp", label: "vide (EVP)", unit: "tonnes" )
c2exp = Type.create!( code: "c2", flow: "exp", label: "plein (EVP)", unit: "tonnes" )
c2imp = Type.create!( code: "c2", flow: "imp", label: "plein (EVP)", unit: "tonnes" )
cexp = Type.create!( code: "c", flow: "exp", label: "Conteneur (EVP)", unit: "tonnes" )
cimp = Type.create!( code: "c", flow: "imp", label: "Conteneur (EVP)", unit: "tonnes" )
d1exp = Type.create!( code: "d1", flow: "exp", label: "pax hors croisieres", unit: "tonnes" )
d1imp = Type.create!( code: "d1", flow: "imp", label: "pax hors croisieres", unit: "tonnes" )
d2exp = Type.create!( code: "d2", flow: "exp", label: "pax croisieres tete de ligne", unit: "tonnes" )
d2imp = Type.create!( code: "d2", flow: "imp", label: "pax croisieres tete de ligne", unit: "tonnes" )
d3exp = Type.create!( code: "d3", flow: "exp", label: "pax croisieres escale", unit: "tonnes" )
d3imp = Type.create!( code: "d3", flow: "imp", label: "pax croisieres escale", unit: "tonnes" )
dexp = Type.create!( code: "d", flow: "exp", label: "passagers", unit: "tonnes" )
dimp = Type.create!( code: "d", flow: "imp", label: "passagers", unit: "tonnes" )
eexp = Type.create!( code: "e", flow: "exp", label: "navires (nb)", unit: "tonnes" )
eimp = Type.create!( code: "e", flow: "imp", label: "navires (nb)", unit: "tonnes" )
