...
a111exp = Type.create!( code: "a111", flow: "exp", label: "petrole brut", unit: "tonnes" )
a111imp = Type.create!( code: "a111", flow: "imp", label: "petrole brut", unit: "tonnes" )
a112exp = Type.create!( code: "a112", flow: "exp", label: "produits raffines", unit: "tonnes" )
a112imp = Type.create!( code: "a112", flow: "imp", label: "produits raffines", unit: "tonnes" )
a113exp = Type.create!( code: "a113", flow: "exp", label: "gaz naturel", unit: "tonnes" )
a113imp = Type.create!( code: "a113", flow: "imp", label: "gaz naturel", unit: "tonnes" )
a11exp = Type.create!( code: "a11", flow: "exp", label: "hydrocarbures", unit: "tonnes" )
a11imp = Type.create!( code: "a11", flow: "imp", label: "hydrocarbures", unit: "tonnes" )
a12exp = Type.create!( code: "a12", flow: "exp", label: "VL hors hydrocarbures", unit: "tonnes" )
a12imp = Type.create!( code: "a12", flow: "imp", label: "VL hors hydrocarbures", unit: "tonnes" )
a1exp = Type.create!( code: "a1", flow: "exp", label: "vrac liquide", unit: "tonnes" )
a1imp = Type.create!( code: "a1", flow: "imp", label: "vrac liquide", unit: "tonnes" )
a21exp = Type.create!( code: "a21", flow: "exp", label: "cereales", unit: "tonnes" )
a21imp = Type.create!( code: "a21", flow: "imp", label: "cereales", unit: "tonnes" )
a22exp = Type.create!( code: "a22", flow: "exp", label: "nourriture animale", unit: "tonnes" )
a22imp = Type.create!( code: "a22", flow: "imp", label: "nourriture animale", unit: "tonnes" )
a23exp = Type.create!( code: "a23", flow: "exp", label: "charbon", unit: "tonnes" )
a23imp = Type.create!( code: "a23", flow: "imp", label: "charbon", unit: "tonnes" )
a24exp = Type.create!( code: "a24", flow: "exp", label: "minerais", unit: "tonnes" )
a24imp = Type.create!( code: "a24", flow: "imp", label: "minerais", unit: "tonnes" )
a25exp = Type.create!( code: "a25", flow: "exp", label: "engrais", unit: "tonnes" )
a25imp = Type.create!( code: "a25", flow: "imp", label: "engrais", unit: "tonnes" )
a26exp = Type.create!( code: "a26", flow: "exp", label: "autres vracs solides", unit: "tonnes" )
a26imp = Type.create!( code: "a26", flow: "imp", label: "autres vracs solides", unit: "tonnes" )
a2exp = Type.create!( code: "a2", flow: "exp", label: "vrac solide", unit: "tonnes" )
a2imp = Type.create!( code: "a2", flow: "imp", label: "vrac solide", unit: "tonnes" )
a311exp = Type.create!( code: "a311", flow: "exp", label: "conteneur lolo (T)", unit: "tonnes" )
a311imp = Type.create!( code: "a311", flow: "imp", label: "conteneur lolo (T)", unit: "tonnes" )
a312exp = Type.create!( code: "a312", flow: "exp", label: "conteneur roro (T)", unit: "tonnes" )
a312imp = Type.create!( code: "a312", flow: "imp", label: "conteneur roro (T)", unit: "tonnes" )
a31exp = Type.create!( code: "a31", flow: "exp", label: "conteneur (T)", unit: "tonnes" )
a31imp = Type.create!( code: "a31", flow: "imp", label: "conteneur (T)", unit: "tonnes" )
a321exp = Type.create!( code: "a321", flow: "exp", label: "roro fret (T)", unit: "tonnes" )
a321imp = Type.create!( code: "a321", flow: "imp", label: "roro fret (T)", unit: "tonnes" )
a322exp = Type.create!( code: "a322", flow: "exp", label: "roro tare (T)", unit: "tonnes" )
a322imp = Type.create!( code: "a322", flow: "imp", label: "roro tare (T)", unit: "tonnes" )
a323exp = Type.create!( code: "a323", flow: "exp", label: "vehicule roulant (T)", unit: "tonnes" )
a323imp = Type.create!( code: "a323", flow: "imp", label: "vehicule roulant (T)", unit: "tonnes" )
a32exp = Type.create!( code: "a32", flow: "exp", label: "roro hors cntr (T)", unit: "tonnes" )
a32imp = Type.create!( code: "a32", flow: "imp", label: "roro hors cntr (T)", unit: "tonnes" )
a33exp = Type.create!( code: "a33", flow: "exp", label: "conventionel et colis lourd", unit: "tonnes" )
a33imp = Type.create!( code: "a33", flow: "imp", label: "conventionel et colis lourd", unit: "tonnes" )
a3exp = Type.create!( code: "a3", flow: "exp", label: "non vrac", unit: "tonnes" )
a3imp = Type.create!( code: "a3", flow: "imp", label: "non vrac", unit: "tonnes" )
aexp = Type.create!( code: "a", flow: "exp", label: "tonnage brut total", unit: "tonnes" )
aimp = Type.create!( code: "a", flow: "imp", label: "tonnage brut total", unit: "tonnes" )
b11exp = Type.create!( code: "b11", flow: "exp", label: "cntr vide 20ft (nb)", unit: "conteneurs" )
b11imp = Type.create!( code: "b11", flow: "imp", label: "cntr vide 20ft (nb)", unit: "conteneurs" )
b12exp = Type.create!( code: "b12", flow: "exp", label: "cntr vide 40ft (nb)", unit: "conteneurs" )
b12imp = Type.create!( code: "b12", flow: "imp", label: "cntr vide 40ft (nb)", unit: "conteneurs" )
b13exp = Type.create!( code: "b13", flow: "exp", label: "cntr vide entre 20ft et 40ft (nb)", unit: "conteneurs" )
b13imp = Type.create!( code: "b13", flow: "imp", label: "cntr vide entre 20ft et 40ft (nb)", unit: "conteneurs" )
b14exp = Type.create!( code: "b14", flow: "exp", label: "cntr vide > 40ft (nb)", unit: "conteneurs" )
b14imp = Type.create!( code: "b14", flow: "imp", label: "cntr vide > 40ft (nb)", unit: "conteneurs" )
b1exp = Type.create!( code: "b1", flow: "exp", label: "cntr vide (nb)", unit: "conteneurs" )
b1imp = Type.create!( code: "b1", flow: "imp", label: "cntr vide (nb)", unit: "conteneurs" )
b21exp = Type.create!( code: "b21", flow: "exp", label: "cntr plein 20ft (nb)", unit: "conteneurs" )
b21imp = Type.create!( code: "b21", flow: "imp", label: "cntr plein 20ft (nb)", unit: "conteneurs" )
b22exp = Type.create!( code: "b22", flow: "exp", label: "cntr plein 40ft (nb)", unit: "conteneurs" )
b22imp = Type.create!( code: "b22", flow: "imp", label: "cntr plein 40ft (nb)", unit: "conteneurs" )
b23exp = Type.create!( code: "b23", flow: "exp", label: "cntr plein entre 20ft et 40ft (nb)", unit: "conteneurs" )
b23imp = Type.create!( code: "b23", flow: "imp", label: "cntr plein entre 20ft et 40ft (nb)", unit: "conteneurs" )
b24exp = Type.create!( code: "b24", flow: "exp", label: "cntr plein > 40ft (nb)", unit: "conteneurs" )
b24imp = Type.create!( code: "b24", flow: "imp", label: "cntr plein > 40ft (nb)", unit: "conteneurs" )
b2exp = Type.create!( code: "b2", flow: "exp", label: "cntr plein (nb)", unit: "conteneurs" )
b2imp = Type.create!( code: "b2", flow: "imp", label: "cntr plein (nb)", unit: "conteneurs" )
bexp = Type.create!( code: "b", flow: "exp", label: "conteneur (nb)", unit: "conteneurs" )
bimp = Type.create!( code: "b", flow: "imp", label: "conteneur (nb)", unit: "conteneurs" )
c1exp = Type.create!( code: "c1", flow: "exp", label: "vide (EVP)", unit: "EVP" )
c1imp = Type.create!( code: "c1", flow: "imp", label: "vide (EVP)", unit: "EVP" )
c2exp = Type.create!( code: "c2", flow: "exp", label: "plein (EVP)", unit: "EVP" )
c2imp = Type.create!( code: "c2", flow: "imp", label: "plein (EVP)", unit: "EVP" )
cexp = Type.create!( code: "c", flow: "exp", label: "Conteneur (EVP)", unit: "EVP" )
cimp = Type.create!( code: "c", flow: "imp", label: "Conteneur (EVP)", unit: "EVP" )
d1exp = Type.create!( code: "d1", flow: "exp", label: "pax hors croisieres", unit: "pax" )
d1imp = Type.create!( code: "d1", flow: "imp", label: "pax hors croisieres", unit: "pax" )
d2exp = Type.create!( code: "d2", flow: "exp", label: "pax croisieres tete de ligne", unit: "pax" )
d2imp = Type.create!( code: "d2", flow: "imp", label: "pax croisieres tete de ligne", unit: "pax" )
d3exp = Type.create!( code: "d3", flow: "exp", label: "pax croisieres escale", unit: "pax" )
d3imp = Type.create!( code: "d3", flow: "imp", label: "pax croisieres escale", unit: "pax" )
dexp = Type.create!( code: "d", flow: "exp", label: "passagers", unit: "pax" )
dimp = Type.create!( code: "d", flow: "imp", label: "passagers", unit: "pax" )
eexp = Type.create!( code: "e", flow: "exp", label: "navires (nb)", unit: "navires" )
eimp = Type.create!( code: "e", flow: "imp", label: "navires (nb)", unit: "navires" )
